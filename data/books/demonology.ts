...
export const demonologyBook: Book = {
  ...
  pages: [
    ...
    {
      title: `${pollywogCombo}`,
      text: `<b>Origin:</b> Australian Aboriginal mythology.\n\n<b>Appearance:</b> Small, red-skinned humanoids with large heads, wide toothless mouths, and suckers on hands and feet.\n\n<b>Modus Operandi:</b> Drops from fig trees onto victims to drain blood with suckers, then swallows and regurgitates them. Repeated attacks cause victims to grow shorter and redder until they transform into <b><span style="color:red">${pollywogCombo}</span></b> themselves.\n\n<b>Typical Location:</b> Fig trees in forests, often near watercourses.`,
    },
    {
      title: `${elSilbonCombo}`,
