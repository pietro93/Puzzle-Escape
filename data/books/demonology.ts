...
export const demonologyBook: Book = {
  ...
  pages: [
    {
      title: `෴`,
      text: `<b>Origin:</b> Rooted in Judeo-Christian apocalyptic tradition, <b><span style="color:red">෴</span></b>—also called Apollyon—is the <i>"Angel of the Abyss."</i>
...
<b>Modus Operandi:</b> <b><span style="color:red">෴</span></b> commands legions of locusts and destructive forces that bring plagues and widespread death. His arrival signals divine wrath and catastrophic ruin.
<b>Typical Location:</b> Emerges from the abyss or desolate battlefields where devastation reigns.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Villages and homes, especially at night.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Places of vice, such as brothels, temples of forbidden worship, and courts rife with intrigue.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Mountains, caves, and desolate wastelands.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Deep forests and remote wilderness.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Graveyards, crossroads, and places associated with injustice.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Cemeteries, abandoned places, and homes.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Burial mounds, ancient tombs, and coastal areas.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Bedrooms and dream realms.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Deserts, ruins, and remote places.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Remote mountain forests and abandoned houses.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Rivers, lakes, and marshes.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Haunts childbirth huts and homes of expectant mothers.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Roams nighttime wilderness near homes with newborns or sleeping men.`,
    },
    {
      title: `෴`,
      text: `<b>Origin:</b> Japanese Folklore.
<b>Appearance:</b> Large, horned ogres with red or blue skin, wild hair, sharp claws, and iron clubs.
<b>Modus Operandi:</b> <b><span style="color:red">෴</span></b> attack with brute force, crushing or devouring victims, and are associated with natural disasters and punishment of sinners.
<b>Typical Location:</b> Mountains, caves, and hellish realms.`,
    },
    {
      title: `෴`,
      text: `<b>Origin:</b> Ancient Mesopotamia.
...
<b>Typical Location:</b> Deserts, windswept plains, and vulnerable households.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Cremation grounds, forests, and abandoned locales.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Banana trees, cemeteries, and dark alleys.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Homes and villages, especially in Zanzibar.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Forests, battlefields, and human settlements after nightfall.`,
    },
    {
      title: `෴`,
      text: `<b>Origin:</b> European folklore.
...
<b>Typical Location:</b> Graveyards, battlefields, and places of violent death.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Graveyards, villages, and rural homes.`,
    },
    {
      title: `෴`,
      text: `<b>Origin:</b> European folklore.
...
<b>Typical Location:</b> Rivers, lakes, caves, and coastal waters.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Rural villages and farms.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Frozen forests and wilderness.`,
    },
    {
      title: `෴`,
...
<b>Modus Operandi:</b> Drops from fig trees onto victims to drain blood with suckers, then swallows and regurgitates them. Repeated attacks cause victims to grow shorter and redder until they transform into <b><span style="color:red">෴</span></b> themselves.
<b>Typical Location:</b> Fig trees in forests, often near watercourses.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Countryside, forests, and rural roads.`,
    },
    {
      title: `෴`,
...
<b>Typical Location:</b> Remote villages and wilderness areas.`,
    },
  ],
}
