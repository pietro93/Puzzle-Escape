...
export const puzzlesSet2: Puzzle[] = [
  ...
  },
  {
    ...
    level: 2,
    sublevel: 3,
    title: "The Master's Palette",
    question: "The butler presents you with a curious color palette.",
    description:
      "A palette gifted to the Master by a renowned French painter. The painter mentioned that the canvas is some sort of treasure map.",
    hint1: "The numbers follow a mathematical pattern.",
    hint2: "Look at the differences between consecutive colors.",
    hint3: "Try to find the relationship between white, black, and grey values.",
