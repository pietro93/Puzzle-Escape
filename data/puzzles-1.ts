...
export const puzzlesSet1: Puzzle[] = [
  ...
  {
    level: 5,
    question: "Look at my boneboxes! How many cubes do you count in total?",
    description: "-",
    imageUrl: "/images/puzzle5.webp",
    imageHint: "/images/bonebox.webp",
    solution: "18",
    category: "pattern",
    hints: [
      "Count all the cubes you can see - and those that you cannot see.",
      "A bonebox has one tiny cube at each angle, and is itself shaped as a cube.",
      "How many boneboxes do you see? I think the guard is messing with you...",
    ],
  },
  {
    level: 6,
