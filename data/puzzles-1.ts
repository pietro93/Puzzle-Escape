...
export const puzzlesSet1: Puzzle[] = [
  ...
  },
  {
    ...
    title: "Magic Square",
    description:
      "Arrange the numbers to create a magic square where all rows, columns, and diagonals sum to the same value.",
    hint: "Try placing the largest number (5) in the center. The magic sum should be 9.",
    character: "sphinx",
    location: "desert",
