...
export default function CoffeeGroundsPuzzle({ onSolve }: CoffeeGroundsPuzzleProps) {
  ...
  // Coffee cup images
  const coffeeImages = [
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coffeegrounds1-CXeqBVjuje6UHoOdgeVHbLq6JDY7Gd.webp", // Storm image with S and Y
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coffeegrounds2-PmpSiU8vOSc64gJE2uzI34Jt2Ji6Xi.webp", // Hourglass/time image with T and S
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coffeegrounds3-OQiJgBbvhaMOMMjgfL6aMhKmzaJ0wF.webp", // Face/head image with A and D
  ]
