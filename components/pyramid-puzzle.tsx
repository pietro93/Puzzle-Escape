...
export default function PyramidPuzzle({
  ...
  const getRoomImage = () => {
    ...
    switch (currentRoom) {
      case "entrance":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-0-XFxyXRHzDcewXk5egWrK4e84bhEYEK.webp"
      case "isis":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-isis-ArtpAdshbFfNBH2jMgFb2GgzHsrP6o.webp"
      case "ra":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-ra-HZIwfHUf5X7F3KKhayOocsCXD2Gf8P.webp"
      case "mural1":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-1-17umS2EqcuHQ4XSp4r5FovveZVbpIx.webp"
      case "mural2":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-2-4yNtwKGVBOAoG14o6gVwk4jvQZOhiY.webp"
      case "mural3":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-3-lWp1neD1t3AEtJiVfUkflWgwUxR4WA.webp"
      case "mural4":
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-4-DK5SATsxVOSxJYuqjKbwEvOTbVqvJS.webp"
      default:
        return "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/wall-0-XFxyXRHzDcewXk5egWrK4e84bhEYEK.webp"
    }
  }
