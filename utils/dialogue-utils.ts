...
const levelDialogue: Record<string, Record<number, string[]>> = {
  skeleton: {
    ...
    5: ["Tik, tok. Tik, tok...", "Round and round we go. Where we stop? Nowhere.", "Stop wasting everyone's time."],
    6: [
    ...
    8: [
      "You know what a Magic Box puzzle is, don't you?",
      "Tsk. I think if you arrange them at random eventually you'll get it right.",
      "This puzzle has broken stronger minds than yours.",
    ],
    9: ["Dots and dashes. How primitive.", "Mphf.", "Tap tap tap. Like the sound of hope fading away."],
    // Level 10 dialogue is handled by guardDialogLines, so removed from here
  },
  butler: {
    11: [
      "The Master was quite fond of exotic spices.",
      ...
      "Perhaps you would prefer a simpler challenge? No? Very well.",
    ],
    12: [
      ...
      "Time is of particular interest to the Master. They have... unusual theories about it.",
      "Roman numerals. So much more elegant than Arabic, don't you agree?",
    ],
    13: [
      "The Master was quite the artist in their spare time.",
      "These pigments are mixed from the rarest ingredients.",
      "Color theory was a particular passion of the Master's.",
      "I do hope you're not colorblind. That would be most unfortunate.",
    ],
    14: [
      ...
      "I've polished these pieces weekly for decades.",
    ...
    15: [
      ...
      "Patricia was quite the sight.",
      "The Master would stare at this portrait for hours. Most disturbing at times.",
    ],
    16: [
      "The Master's library contains over ten thousand volumes.",
      "These particular books were the Master's bedtime reading.",
      "The Master believed books contained more than just words.",
      "I dust these shelves daily. The Master was most particular about their books.",
    ],
    17: [
      "The Master preferred the darkness. Said it sharpened their other senses.",
      "This room has not been illuminated in decades.",
      "The Master could navigate this room blindfolded. Often did, in fact.",
      "Darkness conceals many things. Not all of them pleasant.",
    ],
    18: [
      ...
      "Each piece of silverware has its proper place and value.",
      "The Master was most particular about their table settings.",
    ],
    19: [
      "Count Papagalul has been with the family for generations.",
      "The Count has a rather colorful vocabulary. The Master found it amusing.",
      "I would advise against sudden movements near the Count. He bites.",
      "The Count has outlived three generations of the Master's family.",
    ],
    20: [
      "The family records are meticulously maintained.",
      "The Master was obsessed with their lineage. Spent hours studying it.",
      "The House of Morvane has a most... interesting history.",
      "Some branches of the family tree were deliberately pruned, if you take my meaning.",
    ],
  },
  gypsy: {
    21: [
